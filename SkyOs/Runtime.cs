    ...
    public static class Runtime
    {
        public static void Update()
        {
            ...
            foreach (Window Window in Windows)
            {
                ...
                if (Mouse.MouseState == Cosmos.System.MouseState.Left)
                {
                    if (Mouse.X > Window.Position.X && Mouse.X < Window.Position.X + Window.Size.Width && Mouse.Y > Window.Position.Y && Mouse.Y < Window.Position.Y + Window.Size.Height && Window.TopMost && !Window.Moving && !Dragging)
                    {
                        Windows.Remove(Window);
                        Windows.Insert(Windows.Count, Window);
                    }
        ...
        public static void Stop()
        {
            ...
            Canvas.Current.DrawImage((int)(Canvas.Current.Width / 2 - 30), (int)(Canvas.Current.Height / 2 - 30), 256, 256, Assets.Logo);
        ...
        public static void Restart()
        {
            Canvas.Current.Clear();
            Canvas.Current.DrawImage((int)(Canvas.Current.Width / 2 - 30), (int)(Canvas.Current.Height / 2 - 30), 256, 256, Assets.Logo);
            Canvas.Current.DrawString((int)(Canvas.Current.Width / 2), (int)(Canvas.Current.Height / 2 + 128), "Restarting...", Canvas.Font.Default, Color.White, true);
            Canvas.Current.Update(false);
            foreach (Application App in Applications)
            {
                App.OnDestroy();
